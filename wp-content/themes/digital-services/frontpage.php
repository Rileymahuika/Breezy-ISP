    ...
    <section class="slider-sec">
        <div id="themeSlider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item item <?php echo ($counter==1)?'active':''?>" style="background-image:url(<?php echo esc_url($featured_img_url);?>);">
            ...
            <a class="left carousel-control carousel-control-prev" href="#themeSlider" data-slide="prev">
            <span class="fa fa-chevron-left"></span> </a>
            <a class="right carousel-control carousel-control-next" href="#themeSlider" data-slide="next">
